...
class MyGrowattBattTL3sDevice extends Growatt {
   ...
   */
  async onInit() {
    this.log('MyGrowattBattTL3sDevice has been initialized');
  ...
  async onRenamed(name: string) {
    this.log('MyGrowattBattTL3sDevice was renamed');
  }
   ...
   */
  async onDeleted() {
    this.log('MyGrowattBattTL3sDevice has been deleted');
    this.homey.clearInterval(this.timer);
...
module.exports = MyGrowattBattTL3sDevice;
